...
function A(t) {
    ...
    function i(n) {
        ...
        return t[n].call(o.S, o, o.S, i), o.fa = !0, o.S
    }
    var e = {};
    i.u = t, i.h = e, i.c = function(t, e, n) {
        ...
        if (i.r(n), Object.defineProperty(n, "default", {
            ...
            for (var o in t) i.c(n, o, function(i) {
                return t[i]
            }.bind(null, o));
        return n
    }, i.i = function(t) {
    ...
    function n(t, i) {
        ...
        if (i = i.boundingBoxContainer || document.body, !0 !== f && !a(u)) throw new TypeError("`paneContainer` must be a DOM element when `inlinePane !== true`");
    ...
    function o(t) {
        ...
        }, this.o = this.i("open"), this.Y = this.i("opening"), this.u = this.i("closing"), this.w = this.i("inline"), this.X = this.i("loading"), this.ha()
    }

    function s(t) {
        t = void 0 === t ? {} : t, this.m = this.m.bind(this), this.A = this.A.bind(this), this.g = this.g.bind(this), this.c = this.c.bind(this);
        var i = t;
        t = void 0 === i.b ? f() : i.b;
        var e = void 0 === i.l ? f() : i.l,
            n = void 0 === i.P ? f() : i.P,
            o = void 0 === i.B ? f() : i.B,
        ...
        i = void 0 === i.H ? f() : i.H, this.a = {
            ...
            f: l,
            H: i
        }, (this.a.C || this.a.F) && (this.o = new h({
            j: this.a.j,
            f: this.a.f,
            R: this.a.H
    ...
    h.prototype.g = function(t) {
        ...
        this.a.b.addEventListener("mouseenter", this.g, !1), this.a.b.addEventListener("mouseleave", this.A, !1), this.a.b.addEventListener("mousemove", this.c, !1), this.a.B ? (this.a.b.addEventListener("touchstart", this.g, !1), this.a.b.addEventListener("touchend", this.A, !1), this.a.b.addEventListener("touchmove", this.c, !1)) : (this.a.b.addEventListener("touchstart", this.i, !1), this.a.b.addEventListener("touchend", this.i, !1), this.a.b.addEventListener("touchmove", this.i, !1))
    }, s.prototype.ca = function() {
        this.a.b.removeEventListener("mouseenter", this.g, !1), this.a.b.removeEventListener("mouseleave", this.A, !1), this.a.b.removeEventListener("mousemove", this.c, !1), this.a.B ? (this.a.b.removeEventListener("touchstart", this.g, !1), this.a.b.removeEventListener("touchend", this.A, !1), this.a.b.removeEventListener("touchmove", this.c, !1)) : (this.a.b.removeEventListener("touchstart", this.i, !1), this.a.b.removeEventListener("touchend", this.i, !1), this.a.b.removeEventListener("touchmove", this.i, !1))
    }, s.prototype.g = function(t) {
        t.preventDefault(), this.h = t, "mouseenter" == t.type && this.a.D ? this.u = setTimeout(this.m, this.a.D) : this.a.G ? this.u = setTimeout(this.m, this.a.G) : this.m()
    }, s.prototype.m = function() {
        if (this.enabled) {
            var t = this.a.N;
            t && "function" == typeof t && t(), this.a.l.show(this.a.b.getAttribute(this.a.P), this.a.b.clientWidth, this.a.b.clientHeight), this.h && ((t = this.h.touches) && this.a.F || !t && this.a.C) && this.o.show(this.a.l.b.clientWidth, this.a.l.b.clientHeight), this.c()
        }
    }, s.prototype.A = function(t) {
        t && t.preventDefault(), this.h = null, this.u && clearTimeout(this.u), this.o && this.o.V(), (t = this.a.M) && "function" == typeof t && t(), this.a.l.V()
    }, s.prototype.c = function(t) {
        if (t) t.preventDefault(), this.h = t;
        else {
            if (!this.h) return;
            t = this.h
        }
    ...
    o.prototype.i = function(t) {
        ...
        this.U(), this.s = !0, r(this.b, this.o), r(this.b, this.X), this.c.addEventListener("load", this.m, !1), this.W(t), this.Z(i, e), this.ia ? this.aa() : this.$(), c && (this.b.addEventListener("animationend", this.h, !1), this.b.addEventListener("webkitAnimationEnd", this.h, !1), r(this.b, this.Y))
        ...
        this.U(), this.s = !1, c ? (this.b.addEventListener("animationend", this.g, !1), this.b.addEventListener("webkitAnimationEnd", this.g, !1), r(this.b, this.u)) : (d(this.b, this.o), d(this.b, this.w))
        ...
        this.b.removeEventListener("animationend", this.g, !1), this.b.removeEventListener("webkitAnimationEnd", this.g, !1), d(this.b, this.o), d(this.b, this.u), d(this.b, this.w), this.b.setAttribute("style", ""), this.b.parentElement === this.a.J ? this.a.J.removeChild(this.b) : this.b.parentElement === this.a.v && this.a.v.removeChild(this.b)
    }, o.prototype.m = function() {
        this.c.removeEventListener("load", this.m, !1), d(this.b, this.X)
    ...
    }), n.prototype.setZoomImageURL = n.prototype.U, n.prototype.disable = n.prototype.i, n.prototype.enable = n.prototype.m, n.prototype.destroy = n.prototype.g, window.Drift = n
}]);
